// imu_processor.h — Разбор строк ИМУ после data_reader.
//
// Внутри программы строка всегда:
//   time_s  timestamp_ns  wx  wy  wz  ax  ay  az
// (файл imu.data формата dataset_1786981733 приводится к этому виду при чтении).
//
// Колонки:
//   0 — время (с)
...
// Индексы столбцов во внутреннем формате строки ИМУ.
